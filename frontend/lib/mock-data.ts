...
export const mockTaobaoShops: TaobaoShop[] = [
  {
    ...
    unconfirmedAlipay: { id: "12", name: "丙火网络 支付宝支付在途", balanceMinor: 18_400_00 },
    unconfirmedWechat: { id: "13", name: "丙火网络 微信支付在途", balanceMinor: 6_280_00 },
    aggregatorFrozen: { id: "14", name: "丙火网络 聚合支付·冻结中", balanceMinor: 42_500_00 },
    aggregatorAvailable: { id: "15", name: "丙火网络 聚合支付·可提现", balanceMinor: 12_350_00 },
    bankCard: { id: "16", name: "丙火网络 银行卡", balanceMinor: 80_000_00 },
